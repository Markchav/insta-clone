...
import {
  ...
  Reels,
  Settings,
} from "/src/components/SideBar/NavIcons";
...
import img5 from "/public/assets/badges/PicBurst_Transparent.png";
...
export default function UserProfile({
  ...
  return (
    <div className="flex flex-row w-full h-full">
      <Head>
        <title>{` @${username} | PicBurst`}</title>
        <meta
          name="viewport"
          content="width=device-width, initial-scale=0.65, maximum-scale=0.65, user-scalable=no"
        />
      ...
      <ModalLayout closeModal={closeModal} isOpen={isUploadPostModalOpen}>
        <div className="w-screen h-screen sm:max-w-2xl max-w-xl max-h-[60vh] sm:max-h-[75vh] flex flex-col items-center">
            ...
            {!file ? (
              <div className="flex flex-col justify-center items-center">
                ...
                <div className="p-5">
                  <label
                    htmlFor="post"
                    className="bg-[#0095F6] hover:bg-blue-600 py-2 px-4 text-white active:scale-95 cursor-pointer transform transition  disabled:bg-opacity-50 disabled:scale-100 rounded text-sm font-semibold"
                  >
              ...
              <div className="flex flex-col gap-y-4 ">
                ...
                <input
                  ...
                  value={media.caption}
                  className="w-full px-2 py-2 bg-gray-100 border rounded outline-none hover:bg-transparent focus:bg-transparent focus:border-gray-400"
                />
                <div className="flex items-center justify-center w-full gap-x-6">
                  <button
                    onClick={handleRemovePost}
                    className="bg-[#0095F6] hover:bg-blue-600 py-2 px-4 text-white active:scale-95 cursor-pointer transform transition w-full disabled:bg-opacity-50 disabled:scale-100 rounded text-sm font-semibold"
                  >
                    Remove
                  </button>
                  <button
        ...
        <div className="w-full col-span-2 flex flex-col space-y-5">
          ...
          <div className="fixed sm:hidden top-0 left-0 z-50 w-full h-16 bg-white border-b border-gray-800 mt-3">
            ...
            <div className="flex items-center justify-center ml-40 gap-4 w-full h-6">
              <Link
                ...
                className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md gap-2 px-4 py-2 text-center justify-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 w-32"
              >
          ...
          <section className="flex mx-auto gap-y-5">
            ...
            <div className="h-auto flex flex-col mx-auto sm:ml-10 sm:w-[950px]">
                ...
                <div className="w-full md:w-3/4 p-4 text-center">
                  ...
                  <div className="text-left pl-4 pt-3">
                    <p className="text-base font-medium text-blue-700 mr-2">
                      Welcome to my profile for PicBurst
                    </p>
                    <p className="text-base font-medium text-gray-700 mr-2 w-80">
                      Feel free to roam around feed section{" "}
                    </p>
                  </div>
                </div>
              ...
              {!posts ||
                (posts.length === 0 && (
                  <p className="flex mx-auto justify-center content-center mt-10 text-2xl">
                    No Photos Yet
                  </p>
                ))}
            </div>
        ...
        <div className="fixed bottom-0 left-0 z-50 w-full h-20 bg-white border-t border-gray-800">
          <div className="grid h-full max-w-lg grid-cols-5 mx-auto font-medium gap-28">
            ...
            >
              ...
              <span className="text-lg text-gray-500 dark:text-gray-400 group-hover:text-black dark:group-hover:text-black">
                Home
              </span>
            </button>
            <button
