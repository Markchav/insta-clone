          ...
          <div className="fixed sm:hidden top-0 left-0 z-50 w-full h-14 bg-white border-b border-gray-800">
            ...
            <div className="flex items-center justify-center ml-32 gap-3 w-full">
              <button
                ...
                type="button"
                className=" text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm gap-2 px-4 py-2 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 w-28"
              >
